...
public class GeneticRegressionLearning {
	...
	public GeneticRegressionLearning(double[] weight)
	{
		this.weight = weight;
	}
	
	static public int getTotalFeature()
	{
		return TOTAL_FEATURES;
	}
	
	public GeneticRegressionLearning(int playerNum, String filename) {
