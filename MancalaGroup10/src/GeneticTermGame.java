...
public class GeneticTermGame {
    ...
    public GeneticTermGame (String gameType, int startingStones, String player0Name, String player1Name) {
        try {
    ...
    public static void main(String[] args) 
        ...
        String gameType = "Mancala";
        int ss = 4;

        String[] players = new String[2];
        players[0]="AILearning";
        players[1]="AILearning";
        
            
        GeneticTermGame game = new GeneticTermGame(gameType, ss, players[0], players[1]);
        for (int i =1; i<= 500; i++){
